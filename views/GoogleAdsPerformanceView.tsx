...
export const GoogleAdsPerformanceView: React.FC<{ 
  data: BridgeData[]; 
  ...
  const handleExport = () => {
    ...
    exportToCSV(csvData, "Google_Ads_Performance_Full_Export");
  };
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-6">
      ...
      <div className="bg-white p-6 md:p-8 rounded-[32px] border border-slate-200 shadow-sm overflow-hidden">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <div>
              <h4 className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1">Google Ads Performance by URL</h4>
