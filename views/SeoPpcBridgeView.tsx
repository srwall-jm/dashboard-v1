...
export const SeoPpcBridgeView: React.FC<{ 
  ...
  // Check if we should show SA360 table (either we have data OR we have customers available to select)
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-6">
      ...
      {/* 1. GA4 TABLE - ALWAYS RENDER if data exists or empty state needed */}
      <BridgeAnalysisTable 
