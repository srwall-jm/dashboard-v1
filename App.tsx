...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex flex-col md:flex-row">
     ...
     <aside className={`fixed inset-y-0 left-0 w-80 bg-slate-950 text-white flex flex-col z-50 shadow-2xl transition-all duration-300 ease-in-out transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
  <div className="p-8 overflow-y-auto flex-1 custom-scrollbar">
    <div className="flex items-center justify-between mb-8">
      ...
      {/* Botón para cerrar en escritorio/portátil */}
      <button 
  ...
  {/* Footer del Aside: Usuario y Conexiones */}
